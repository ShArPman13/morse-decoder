...
function decode(expr) {
    ...
    function separateByTenZeroOff() { //разбиваем входную строку по 10 символов
        arrOfLetters = [];
    ...
    function deleteZero() { //удаляем нули
    ...
    function replace() { //меняем пары 11 и 10 на точки и тире, звездочки оставляем как есть
    ...
    function myDecode() { // декодируем полученные буквы морзе в нормальные буквы, а * в пробелы
        const array = replace();
        let str = '';
